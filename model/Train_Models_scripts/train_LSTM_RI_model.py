# =====================================================
# File: train_and_evaluate_lstm_ri.py
# Purpose: Train LSTM severity classifier safely on RI dataset with dropout and stable training
# =====================================================
...
DATA_FOLDER = "../Data_Sets_training/LSTM_Dataset_RI"  # RI dataset folder created previously
MODEL_FOLDER = "../Saved_Models_Files/Saved_Model_RI"  # RI-specific saved models
...
print("Positive class ratio (train):", np.mean(y_train))
...
MODEL_PATH = os.path.join(MODEL_FOLDER, "final_model_ri.keras")
...
print(f"Using threshold {best_thresh:.2f} for best recall: {best_recall:.4f}")
...
if recall < 0.85:
    print("\n⚠ WARNING:")
    print("Model misses too many high-severity events in RI dataset.")
...
model_info = {
    ...
    "dataset": {
        ...
        "source": "RI dataset - LSTM training folder",
...
print(f"Model info (including history) saved to JSON: {json_path}")